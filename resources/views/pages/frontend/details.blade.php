...
@section('content')
    ...
    <section class="container mx-auto">
        ...
        <div class="flex-1 px-4 md:p-6">
            ...
            <h6 class="text-xl font-semibold mb-4">Deskripsi Kue</h6>
    ...
    <section class="bg-gray-100 px-4 py-16">
        ...
        <div class="flex flex-start mb-4">
            ...
            Kue yang mungkin   <br class="" />Anda inginkan
            </h3>
        </div>
        <div class="flex overflow-x-auto mb-4 -mx-3">
            ...
            <div class="px-3 flex-none" style="width: 320px">
                <div class="rounded-xl p-4 pb-8 relative bg-white">
                    ...
                    <img
                        src="{{ $item->galleries()->exists() ? Storage::url($item->galleries->first()->url) : "data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" }}"
                        alt=""
