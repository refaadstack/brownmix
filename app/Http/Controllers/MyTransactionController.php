    ...
    public function index()
    {
        if(request()->ajax()){
            ...
            ->addColumn('action', function($item){
                return '
                    <a href="'. route('dashboard.my-transaction.show', $item->id) .'" class="bg-purple-400 hover:bg-purple-500 text-white font-bold py-1 px-3 mr-2 md:my-4 rounded shadow-lg">
                        Show
                    </a>    
                ';
            })
